...
The code we’d written followed a consistent coding convention.
Our code individually aligned with the specifications of the design proposed in the previous group meeting.
Our code collectively worked together without any hiccups.
Any pseudo code was converted into code, or discussed at the group meeting.
...
decodeAndExecture takes the instruction to find out what type of instruction it is (Branch, Data Processing, etc.)
Depending on the type of instruction, the relevant method is called and the necessary steps, such as updating results, CPSR flags, etc. are taken.
This loops until the halt instruction is fetched.
